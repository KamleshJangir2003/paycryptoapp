    ...
    <div class="card">
        <div class="card-body p-4" style="background: #fff; color: #333;">
            ...
            <div style="margin-bottom: 25px;">
                <div style="font-size: 13px; font-weight: bold; color: #fff; background: #333; padding: 8px 12px; margin-bottom: 12px; text-transform: uppercase;">User Information</div>
            ...
            <div style="margin-bottom: 25px;">
                ...
                <div style="background: #f9f9f9; border: 1px solid #e0e0e0; padding: 15px; border-radius: 5px;">
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        <span style="color: #666; font-size: 12px; font-weight: bold;">PROOF</span>
                        <a href="{{ asset('storage/' . $withdrawal->proof_screenshot) }}" target="_blank" style="color: #0066cc; text-decoration: underline; font-size: 12px;">View Receipt</a>
                    </div>
                    @endif
                </div>
            </div>
            ...
            {{-- Summary --}}
            <div style="margin-bottom: 25px;">
                <div style="font-size: 13px; font-weight: bold; color: #fff; background: #333; padding: 8px 12px; margin-bottom: 12px; text-transform: uppercase;">Withdrawal Summary</div>
                <div style="background: #f9f9f9; border: 1px solid #e0e0e0; padding: 15px; border-radius: 5px;">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 10px; padding-bottom: 10px; border-bottom: 1px solid #e0e0e0;">
            ...
            <div style="margin-top: 40px; padding-top: 20px; text-align: center; color: #666; font-size: 11px;">
                <p>This is an official receipt of the withdrawal transaction.</p>
