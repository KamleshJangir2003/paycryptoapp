...
<div class="row g-3 mb-4">
    <div class="col-6">
        <a href="https://chat.whatsapp.com/YOUR_WHATSAPP_GROUP_LINK" target="_blank" class="card p-3 text-decoration-none d-flex flex-row align-items-center gap-3">
            ...
            <div>
                <div style="color:#25D366; font-weight:700; font-size:.95rem;">WhatsApp Group</div>
                <div style="color:#7777aa; font-size:.78rem;">Join our community</div>
            </div>
        </a>
    </div>
    <div class="col-6">
        <a href="https://t.me/YOUR_TELEGRAM_GROUP_LINK" target="_blank" class="card p-3 text-decoration-none d-flex flex-row align-items-center gap-3">
            <div style="width:44px; height:44px; background:#0088cc; border-radius:50%; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
            ...
            <div>
                <div style="color:#0088cc; font-weight:700; font-size:.95rem;">Telegram Group</div>
                <div style="color:#7777aa; font-size:.78rem;">Join our channel</div>
            </div>
        </a>
    </div>
</div>
